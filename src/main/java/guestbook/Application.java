...
public class Application {
	...
	CommandLineRunner init(GuestbookRepository guestbook) {
		...
		return args -> {
			...
			Stream.of( //
					new GuestbookEntry("H4xx0r", "dude@dude.me","first!!!"), //
					new GuestbookEntry("Arni", "avocados.from.mexico@superbowl.us","Hasta la vista, baby"), //
					new GuestbookEntry("Duke Nukem", "duke.nukem@apocalypse.de","It's time to kick ass and chew bubble gum. And I'm all out of gum."), //
					new GuestbookEntry("Gump1337", "bockwurst@wilke.lecker",
